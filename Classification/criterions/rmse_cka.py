...
class RMSE_CKA(CrossEntropyLoss):
    ...
    def forward(
        ...
        def compute_att_loss_1(teacher_model, student_model, input_data, k):
            ...
            for i in range(batch_size):
                ...
                for teacher_att, student_att in zip(teacher_last_k_layers, student_last_k_layers):
                    ...
                    print(loss_mse(student_att_for_n_token, teacher_att_for_n_token))
        ...
        loss = (1.0 - self.kd_rate) * loss_ce + self.kd_rate * (att_loss_total_1 + att_loss_total_2) # Hàm loss cuối cùng
        log["loss"] = loss
